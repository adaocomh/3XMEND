...
const EmailLink: React.FC<EmailProps> = ({
  ...
  return (
    <a
      ...
      onClick={handleClick}
    >
      <Image className='hoverSeta' src="/icons/email-blue.png" alt="Icon do email" width={30} height={30} />
    </a>
  )
}
  ...
  return (
    <div className="slideMenu4 flex gap-[10px]">
      ...
      <a href="https://wa.me/5511956747411?text=Olá!%20Gostaria%20de%20saber%20mais%20sobre%20os%20serviços%20oferecidos%20pela%203XMEND." className="flex justify-center items-center w-[50px] h-[50px] bg-[var(--background)] rounded-full hoverSeta" target="_blank" rel="noopener noreferrer">
        <Image className='hoverSeta' src="/icons/whatsapp-blue.png" alt="Icon do whatsapp" width={30} height={30} />
      </a>
      ...
      <a onClick={copiarTelefone} ref={emailRef} className="flex justify-center items-center w-[50px] h-[50px] bg-[var(--background)] rounded-full hoverSeta">
        {copiado ? <Image className='hoverSeta' src="/icons/copy-blue.png" alt="Icon do telefone" width={30} height={30} /> : <Image className='hoverSeta' src="/icons/telephone-blue.png" alt="Icon do telefone" width={30} height={30} />}
      </a>
