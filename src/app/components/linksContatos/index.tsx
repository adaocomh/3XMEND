...
export default function LinksContatos() {
  ...
  return (
    <div className="flex gap-[10px]">
      ...
      <a onClick={copiarTelefone} ref={emailRef} className="flex justify-center items-center w-[50px] h-[50px] bg-[var(--background)] rounded-full hoverSeta">
        {copiado ? <Image className='hoverSeta' src="/icons/copy.png" alt="Icon do telefone" width={30} height={30} /> : <Image className='hoverSeta' src="/icons/telephone.png" alt="Icon do telefone" width={30} height={30} />}
      </a>
