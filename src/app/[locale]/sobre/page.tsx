            ...
            <h1 className="text-[50px] font-black text-(--background) text-center md:text-[75px]">{t("impacto")}</h1>
                <div className="flex justify-between">
                    <div className="flex flex-col items-center">
                        <h1 className="text-[50px] font-black text-(--background) md:text-[75px]"><Contador target={12} duration={1500}/></h1>
                        <h6 className="text-[20px] text-(--background) font-bold md:text-[35px]">{t("parceiros")}</h6>
                    </div>
                    <div className="flex flex-col items-center">
                        <h1 className="text-[50px] font-black text-(--background) md:text-[75px]"><Contador target={25} duration={1500}/>M</h1>
                        <h6 className="text-[20px] text-(--background) font-bold md:text-[35px]">{t("visualizacao")}</h6>
                    </div>
                    <div className="flex flex-col items-center">
                        <h1 className="text-[50px] font-black text-(--background) md:text-[75px]"><Contador target={4} duration={1500}/></h1>
                        <h6 className="text-[20px] text-(--background) font-bold md:text-[35px]">{t("carreira")}</h6>
                    </div>
                </div>
            </div>
        </div>
